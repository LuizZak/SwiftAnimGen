...
struct StringTests {
    ...
    @Test
    func trimWhitespace() {
        assertEqual(SwiftAnimGen.trimWhitespace(""), "")
        assertEqual(SwiftAnimGen.trimWhitespace("  "), "")
        assertEqual(SwiftAnimGen.trimWhitespace("a "), "a")
        assertEqual(SwiftAnimGen.trimWhitespace(" a"), "a")
        assertEqual(SwiftAnimGen.trimWhitespace("abc"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespace("abc "), "abc")
        assertEqual(SwiftAnimGen.trimWhitespace(" abc"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespace("  abc "), "abc")
        assertEqual(SwiftAnimGen.trimWhitespace("\nabc\n"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespace("\n abc def \t "), "abc def")
        assertEqual(SwiftAnimGen.trimWhitespace("  abc def "), "abc def")
    }

    @Test
    func trimWhitespaceLead() {
        assertEqual(SwiftAnimGen.trimWhitespaceLead(""), "")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("  "), "")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("a "), "a ")
        assertEqual(SwiftAnimGen.trimWhitespaceLead(" a"), "a")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("abc"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("abc "), "abc ")
        assertEqual(SwiftAnimGen.trimWhitespaceLead(" abc"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("  abc "), "abc ")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("\nabc\n"), "abc\n")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("\n abc def \t "), "abc def \t ")
        assertEqual(SwiftAnimGen.trimWhitespaceLead("  abc def "), "abc def ")
    }

    @Test
    func trimWhitespaceTrail() {
        assertEqual(SwiftAnimGen.trimWhitespaceTrail(""), "")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("  "), "")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("a "), "a")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail(" a"), " a")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("abc"), "abc")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("abc "), "abc")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail(" abc"), " abc")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("  abc "), "  abc")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("\nabc\n"), "\nabc")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("\n abc def \t "), "\n abc def")
        assertEqual(SwiftAnimGen.trimWhitespaceTrail("  abc def "), "  abc def")
    }
}
